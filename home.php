...
<!-- Mirrored from dsathemes.com/html/martex_1.1/files/blog-listing.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Mar 2024 13:54:33 GMT -->
<head>
							...
							<!-- BLOG POST IMAGE -->
				 			<div class="col-md-6">
				 				<div class="blog-post-img">
									<img class="img-fluid r-16" src="images/blog/post-11-img.jpg" alt="blog-post-image">
								</div>	
							</div>
					 		...
					 		<div class="col-md-6 col-lg-4">
					 			<div class="blog-post mb-40 wow fadeInUp clearfix">	
					 				...
					 				<div class="blog-post-img mb-35">
										<img class="img-fluid r-16" src="images/blog/post-1-img.jpg" alt="blog-post-image">
									</div>	
							...
							<!-- BLOG POST #3 -->
					 		<div class="col-md-12 col-lg-4">
					 			<div class="blog-post mb-40 wow fadeInUp clearfix">	
					 				...
					 				<!-- BLOG POST IMAGE -->
					 				<div class="blog-post-img mb-35">
										<img class="img-fluid r-16" src="images/blog/post-3-img.jpg" alt="blog-post-image">
									</div>	
							...
							<!-- BLOG POST #4 -->
					 		<div class="col-md-6 col-lg-4">
					 			<div class="blog-post mb-40 wow fadeInUp clearfix">	
					 				...
					 				<!-- BLOG POST IMAGE -->
					 				<div class="blog-post-img mb-35">
										<img class="img-fluid r-16" src="images/blog/post-4-img.jpg" alt="blog-post-image">
									</div>	
							...
							<!-- BLOG POST #6 -->
					 		<div class="col-md-12 col-lg-4">
					 			<div class="blog-post mb-40 wow fadeInUp clearfix">	
					 				...
					 				<!-- BLOG POST IMAGE -->
					 				<div class="blog-post-img mb-35">
										<img class="img-fluid r-16" src="images/blog/post-6-img.jpg" alt="blog-post-image">
									</div>	
									...
									<div class="row d-flex align-items-center">
										...
										<div class="col-md-6 order-first order-md-2">
							 				<div class="blog-post-img video-preview">
												...
												<!-- Preview Image --> 
							 					<img class="img-fluid" src="images/blog/post-10-img.jpg" alt="video-preview">
							...
							<!-- BLOG POST #7 -->
					 		<div class="col-md-6 col-lg-4">
					 			<div class="blog-post mb-40 wow fadeInUp clearfix">	
					 				...
					 				<!-- BLOG POST IMAGE -->
					 				<div class="blog-post-img mb-35">
										<img class="img-fluid r-16" src="images/blog/post-7-img.jpg" alt="blog-post-image">
									</div>	
									...
									<div class="blog-post-txt">
										...
										<!-- Post Link -->
										<h6 class="s-20 w-700">
											<a href="single-post.html">Phasellus blandit justo undo aliquam diam vitae 
											   molestie
											</a>
										</h6>
							...
							<!-- BLOG POST #9 -->
					 		<div class="col-md-12 col-lg-4">
					 			<div class="blog-post mb-40 wow fadeInUp clearfix">	
					 				...
					 				<!-- BLOG POST IMAGE -->
					 				<div class="blog-post-img mb-35">
										<img class="img-fluid r-16" src="images/blog/post-9-img.jpg" alt="blog-post-image">
									</div>	
...
<!-- Mirrored from dsathemes.com/html/martex_1.1/files/blog-listing.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Mar 2024 13:54:37 GMT -->
</html>