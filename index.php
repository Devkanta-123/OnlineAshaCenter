...
<!-- Mirrored from dsathemes.com/html/martex_1.1/files/demo-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Mar 2024 13:52:58 GMT -->
			...
			<div class="chBody white-color">
				...
				<div class="stBlock text-center" style="margin: 30px 20px 20px 26px;">
					<div class="stBgs">
						...
						<a href="javascript:chooseStyle('blue-theme', 60)"><img src="images/color-scheme/blue.jpg"
								alt=""></a>
						<a href="javascript:chooseStyle('red-theme', 60)"><img src="images/color-scheme/red.jpg"
								alt=""></a>
						<a href="javascript:chooseStyle('purple-theme', 60)"><img src="images/color-scheme/purple.jpg"
								alt=""></a>
						<a href="javascript:chooseStyle('violet-theme', 60)"><img src="images/color-scheme/violet.jpg"
								alt=""></a>
						<a href="javascript:chooseStyle('skyblue-theme', 60)"><img src="images/color-scheme/skyblue.jpg"
								alt=""></a>
						<a href="javascript:chooseStyle('magenta-theme', 60)"><img src="images/color-scheme/magenta.jpg"
								alt=""></a>
						<a href="javascript:chooseStyle('crocus-theme', 60)"><img src="images/color-scheme/crocus.jpg"
								alt=""></a>
						<a href="javascript:chooseStyle('green-theme', 60)"><img src="images/color-scheme/green.jpg"
								alt=""></a>
				...
				<div class="stBlock text-center" style="margin: 0px 27px 25px 31px;">
					<a class="btn r-04 btn--theme hover--theme" href="javascript:chooseStyle('none', 60)">Reset
						Color</a>
				</div>
					...
					<div class="wsmainwp clearfix">
						...
						<div class="desktoplogo">
							<a href="#hero-1" class="logo-black">
								<img class="light-theme-img" src="images/logo-pink.png" alt="logo">
								<img class="dark-theme-img" src="images/logo-pink-white.png" alt="logo">
							</a>
						</div>
						...
						<nav class="wsmenu clearfix">
							<ul class="wsmenu-list nav-theme">
								...
								<li class="nl-simple reg-fst-link mobile-last-link" aria-haspopup="true">
									<a href="userlogin.php" class="h-link">Sign in</a>
								</li>


								<!-- SIGN UP BUTTON -->
								<li class="nl-simple" aria-haspopup="true">
									<a href="userRegistration.php" class="btn r-04 btn--theme hover--tra-white last-link">Sign
										up</a>
								</li>
						...
						<div class="col-md-6">
							<div class="fbox-5 fb-1 bg--white-400 r-16 wow fadeInUp">
								...
								<div class="fbox-txt order-last order-md-2">
									...
									<p>Aliquam a augue suscipit luctus diam neque purus ipsum neque and dolor primis
										libero</p>
								</div>
								...
								<div class="fbox-5-img order-first order-md-2">
									...
									<img class="img-fluid dark-theme-img" src="images/f_06_dark.png"
										alt="feature-image">
								</div>
						...
						<div class="col-md-6">
							<div class="fbox-5 fb-2 bg--white-400 r-16 wow fadeInUp">
								...
								<div class="fbox-5-img">
									...
									<img class="img-fluid dark-theme-img" src="images/f_04_dark.png"
										alt="feature-image">
								</div>
						...
						<div class="owl-carousel brands-carousel-5">
							...
							<div class="brand-logo">
								<a href="#"><img class="img-fluid light-theme-img" src="images/brand-1.png"
										alt="brand-logo"></a>
								<a href="#"><img class="img-fluid dark-theme-img" src="images/brand-1-white.png"
										alt="brand-logo"></a>
							</div>
							...
							<div class="brand-logo">
								<a href="#"><img class="img-fluid light-theme-img" src="images/brand-2.png"
										alt="brand-logo"></a>
								<a href="#"><img class="img-fluid dark-theme-img" src="images/brand-3-white.png"
										alt="brand-logo"></a>
							</div>
							...
							<div class="brand-logo">
								<a href="#"><img class="img-fluid light-theme-img" src="images/brand-4.png"
										alt="brand-logo"></a>
								<a href="#"><img class="img-fluid dark-theme-img" src="images/brand-4-white.png"
										alt="brand-logo"></a>
							</div>
							...
							<div class="brand-logo">
								<a href="#"><img class="img-fluid light-theme-img" src="images/brand-5.png"
										alt="brand-logo"></a>
								<a href="#"><img class="img-fluid dark-theme-img" src="images/brand-5-white.png"
										alt="brand-logo"></a>
							</div>
							...
							<div class="brand-logo">
								<a href="#"><img class="img-fluid light-theme-img" src="images/brand-6.png"
										alt="brand-logo"></a>
								<a href="#"><img class="img-fluid dark-theme-img" src="images/brand-6-white.png"
										alt="brand-logo"></a>
							</div>
							...
							<div class="brand-logo">
								<a href="#"><img class="img-fluid light-theme-img" src="images/brand-7.png"
										alt="brand-logo"></a>
								<a href="#"><img class="img-fluid dark-theme-img" src="images/brand-7-white.png"
										alt="brand-logo"></a>
							</div>
							...
							<div class="brand-logo">
								<a href="#"><img class="img-fluid light-theme-img" src="images/brand-8.png"
										alt="brand-logo"></a>
								<a href="#"><img class="img-fluid dark-theme-img" src="images/brand-8-white.png"
										alt="brand-logo"></a>
							</div>
							...
							<div class="brand-logo">
								<a href="#"><img class="img-fluid light-theme-img" src="images/brand-9.png"
										alt="brand-logo"></a>
								<a href="#"><img class="img-fluid dark-theme-img" src="images/brand-9-white.png"
										alt="brand-logo"></a>
							</div>
						...
						<div class="col">
							<div class="fbox-2 fb-1 wow fadeInUp">
								...
								<div class="fbox-img gr--whitesmoke h-175">
									...
									<img class="img-fluid dark-theme-img" src="images/f_01_dark.png"
										alt="feature-image">
								</div>
						...
						<div class="col">
							<div class="fbox-2 fb-2 wow fadeInUp">
								...
								<div class="fbox-img gr--whitesmoke h-175">
									...
									<img class="img-fluid dark-theme-img" src="images/f_05_dark.png"
										alt="feature-image">
								</div>
						...
						<div class="col">
							<div class="fbox-2 fb-3 wow fadeInUp">
								...
								<div class="fbox-img gr--whitesmoke h-175">
									...
									<img class="img-fluid dark-theme-img" src="images/f_02_dark.png"
										alt="feature-image">
								</div>
				...
				<div class="row">
					<div class="col">
						<div class="img-block-btn text-center wow fadeInUp">
							...
							<!-- Button -->
							<a href="#integrations-2" class="btn r-04 btn--tra-black hover--theme">Monitor your
								activity</a>
					...
					<div class="row justify-content-md-center row-cols-1 row-cols-md-3">
						...
						<div class="col">
							<div id="rb-1-1" class="rbox-1">
								...
								<div class="rbox-1-img">
									<img class="img-fluid light-theme-img" src="images/brand-21.png"
										alt="feature-image">
									<img class="img-fluid dark-theme-img" src="images/brand-21-white.png"
										alt="feature-image">
								</div>
						...
						<div class="col">
							<div id="rb-1-2" class="rbox-1">
								...
								<!-- Brand Logo -->
								<div class="rbox-1-img">
									<img class="img-fluid light-theme-img" src="images/brand-22.png"
										alt="feature-image">
									<img class="img-fluid dark-theme-img" src="images/brand-22-white.png"
										alt="feature-image">
								</div>
						...
						<div class="col">
							<div id="rb-1-3" class="rbox-1">
								...
								<!-- Brand Logo -->
								<div class="rbox-1-img">
									<img class="img-fluid light-theme-img" src="images/brand-23.png"
										alt="feature-image">
									<img class="img-fluid dark-theme-img" src="images/brand-23-white.png"
										alt="feature-image">
								</div>
						...
						<div class="row">
							...
							<div class="col">
								<div class="banner-3-txt color--white">
									...
									<!-- Button -->
									<a href="signup-1.html" class="btn r-04 btn--theme hover--tra-white">Get srarted -
										it's free</a>
...
<!-- Mirrored from dsathemes.com/html/martex_1.1/files/demo-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Mar 2024 13:53:46 GMT -->
